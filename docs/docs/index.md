<div class="article-listing">
    ...
    <p>Explains how to retrieve actionable error information for Tenant Configuration Management monitor runs and snapshot jobs by explicitly selecting the errorDetails property in Microsoft Graph API calls.</p>
</div>
